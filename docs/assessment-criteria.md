...
| 1.6 Styled Python and validated front end | Python style and JavaScript lint pass; 23 HTML samples passed with zero errors/warnings; project-owned CSS passed official URI validation with zero errors and eight warnings | 2–4 | Complete | `docs/formal-validation.md`, `docs/testing.md` |
